...
import { handleSuccess } from "../utils"; // Assuming handleError is for errors, keep it if needed
import { RiLogoutCircleRLine } from "react-icons/ri";

const AdminDash = () => {
  const [activeComponent, setActiveComponent] = useState("attendanceRecord");
  ...
  return (
    <section>
      <div className="flex flex-col md:flex-row mb-10 text-gray-50">
