...
function EmpSignUp() {
  ...
  const handleSignup = async (e) => {
    ...
    const { empName, empEmail, empPhone, empId, empPassword, empGender } = empSignupInfo;
    ...
    try {
      const response = await fetch('http://localhost:8080/auth/signup/employee', {
        method: 'POST',
